...
to be confused with :mod:`obp.sos` (raw "at most k adjacent
nonzero" constraints on existing variables) or :mod:`obp.mccormick`
...
:mod:`obp.sos` to enforce "at most two adjacent lambda nonzero").
...
def piecewise_linear_1d(
    ...
    :class:`obp.sos.SOSConstraint` for what each method means).
